...
export default function Home() {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const newFilteredTasks: Task[] = tasks.filter((task) =>
      task.title.toLowerCase().includes(value.toLowerCase()) || task.description.toLowerCase().includes(value.toLowerCase())
    );
